	...
	return (
		...
		>
			<div className="relative h-16 w-full">
				...
				<div className="w-full h-full max-w-7xl mx-auto flex items-center justify-between gap-0 px-4 sm:px-6 lg:px-8">
					<div className="shrink-0 flex items-center gap-2">{left}</div>
